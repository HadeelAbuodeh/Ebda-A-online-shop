@extends('Admain.main')
    ...
    <div class="card mx-4 mb-4" style="width: auto">
  <div class="card-body">
    <h4 class="card-title text-center">Order #{{$order->id}}</h4><hr>
    <h5 class="card-subtitle mb-2 text-muted">Client Info :</h5>
...
<a class="btn btn-primary px-3 mb-4" href="{{route('make-done',$order)}}" role="button">Done</a>
</div>
</div>
     @endforeach
